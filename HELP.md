...
* The original package name 'com.cicd.cicd-applied-to-spring-boot-java-app' is invalid and this project uses 'com.cicd.cicd_applied_to_spring_boot_java_app' instead.
